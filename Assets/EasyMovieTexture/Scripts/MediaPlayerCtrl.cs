        ...
        if (m_CurrentState == MEDIAPLAYER_STATE.PLAYING || m_CurrentState == MEDIAPLAYER_STATE.PAUSED)
        {
			if (m_bCheckFBO == false) {
				...
				m_iHeight = Call_GetVideoHeight ();
					Debug.LogError("1st width - "+m_iWidth+" height - "+m_iHeight);
				Resize ();
				ResizeTexture();
				...
				if (Call_GetVideoWidth () != m_iWidth || Call_GetVideoHeight () != m_iHeight) {
					m_iWidth = Call_GetVideoWidth ();
					m_iHeight = Call_GetVideoHeight ();
						Debug.LogError("width - "+m_iWidth+" height - "+m_iHeight);
...
//		if( m_iWidth != Screen.width)
//			Resize();
//				
//		if( m_iHeight != Screen.height)
//			Resize();
	...
	public void DeleteVideoTexture()
	{
		...
		public void UpdateWidthAndHeight()
		{
			...
			m_iHeight = Call_GetVideoHeight ();
			if(m_VideoTexture != null)
				Debug.LogError("m_iWidth + "+m_iWidth+" m_iHeight + "+m_iHeight+" "+m_VideoTexture.width+" "+m_VideoTexture.height);
			else
				Debug.LogError("m_iWidth + "+m_iWidth+" m_iHeight + "+m_iHeight+" is null");
