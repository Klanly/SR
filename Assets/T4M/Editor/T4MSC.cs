		...
		if (CurrentSelect && Selection.activeInstanceID != T4MSelectID || UnityTerrain && T4MMenuToolbar != 0 || T4MMenuToolbar != 3 && T4MPreview){
			...
			GUILayout.EndHorizontal();
				...
				if(CurrentSelect != null && T4MActived =="Activated"){
					...
					if (CurrentSelect.GetComponent <T4MObjSC>() && !CurrentSelect.gameObject.GetComponent <T4MObjSC>().T4MMaterial ||CurrentSelect.GetComponent <T4MObjSC>() && !CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMesh || CurrentSelect.GetComponent <T4MObjSC>() && CurrentSelect.gameObject.GetComponent <T4MObjSC>().T4MMaterial != CurrentSelect.renderer.sharedMaterial){
