...
public class CarouselRuneCoverFlow : MonoBehaviour 
{
...
//		{
//			
//			RuneName.Text = gameObject.transform.GetChild(selectedIndex).GetComponent<item>().upgradeDescription;
//			RuneLevel.Text = "Level " +gameObject.transform.GetChild(selectedIndex).GetComponent<item>().upgradeLevel.ToString();
...
//		}
		...
		if(!isUpgrade)
		{
			RuneName.Text = gameObject.transform.GetChild((gameObject.transform.childCount-1) - selectedIndex).GetComponent<DragRune>()._runeModel.ItemName();
			RuneLevel.Text = "Level " +gameObject.transform.GetChild((gameObject.transform.childCount-1) - selectedIndex).GetComponent<DragRune>()._runeModel.skullLevel;
	...
	public void gotoRune(int index)
	{
