...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class CameraFadeOut : FsmStateAction
	{
		...
		public override void Reset()
		{
			...
			time = 1.0f;
			finishEvent = null;
//			Debug.LogWarning("Reset CameraFadeOut - "+this.Name+" "+this.Owner.name+" "+StackTraceUtility.ExtractStackTrace());
		}
...
//			Debug.LogWarning("OnEnter CameraFadeOut - "+this.Name+" "+this.Owner.name+" "+StackTraceUtility.ExtractStackTrace());

		}

		public override void OnUpdate()
		{
//			Debug.LogWarning("OnUpdate CameraFadeOut - "+this.Name+" "+this.Owner.name);
			if (realTime)
			{
			...
			if (currentTime > time.Value)
			{
				if (finishEvent != null)
				{
					...
					Debug.LogWarning("Camera Fade Out - "+this.Name);
					LogWarning("Camera Fade Out - "+this.Name);
				}
